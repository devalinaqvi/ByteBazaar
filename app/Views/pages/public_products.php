...
<div class="bg-white">
    <main class="mx-auto max-w-2xl px-4 lg:max-w-7xl lg:px-8">
        <div class="border-b border-gray-200 pt-24 pb-10">
            ...
            <p class="mt-4 text-base text-gray-500">Checkout out the latest prices!</p>
        </div>
                        ...
                        <?php foreach ($products as $product) : ?>
                            <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                                ...
                                <img src="<?= $product->image_url ? upload_url($product->image_url) : url_path('assets/images/placeholder.png') ?>"
                                     ...
                                     class="aspect-3/4 bg-gray-200 object-contain group-hover:opacity-75 sm:h-96" />

                                <div class="flex flex-1 flex-col space-y-2 p-4">

                                    <h3 class="text-sm font-medium text-gray-900">
                                        <a  href="<?= url_path('product/' . htmlspecialchars($product->slug)) ?>">

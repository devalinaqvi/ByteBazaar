    ...
    <div class="divide-y divide-gray-900/10">
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm/6 text-gray-600">Add a new category to organize your products.</p>
            </div>

            <form method="POST" action="<?= url_path('admin/categories/create') ?>" class="bg-white shadow-xs outline outline-gray-900/5 sm:rounded-xl md:col-span-2">

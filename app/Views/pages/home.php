                ...
                <div class="mt-6 grid grid-cols-2 gap-x-4 gap-y-10 sm:gap-x-6 md:grid-cols-4 md:gap-y-0 lg:gap-x-8">
                    ...
                    <div class="group relative">
                        <div class="h-56 w-full overflow-hidden rounded-md group-hover:opacity-75 lg:h-72 xl:h-80">
                            <img src="<?php echo $product->image_url ? upload_url($product->image_url) : url_path('assets/images/placeholder.png'); ?>" alt="<?php echo e($product->name); ?>" class="size-full object-contain" />
                        </div>
